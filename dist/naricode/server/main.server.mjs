...
var ServerXhr = class _ServerXhr {
  ...
  async \u0275loadImpl() {
    if (!this.xhrImpl) {
      ...
      const {
        default: xhr
      } = await import("./chunk-UXKTHKEQ.mjs");
      this.xhrImpl = xhr;
    }
  }
  build() {
  ...
  constructor() {
    ...
    if (config3.url) {
      const {
        ...
        href,
        origin
      } = resolveUrl(config3.url, this.origin);
...
function _document() {
  ...
  if (config3 && config3.document) {
    document2 = typeof config3.document === "string" ? _enableDomEmulation ? parseDocument(config3.document, config3.url !== void 0 ? resolveUrl(config3.url, "http://localhost").href : void 0) : window.document : config3.document;
  } else {
...
var _c0 = (a0) => ({ exact: a0 });
var _forTrack0 = ($index, $item) => $item.ruta;
function NavbarComponent_For_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", enlace_r1.ruta)("routerLinkActiveOptions", \u0275\u0275pureFunction1(3, _c0, enlace_r1.exacto));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", enlace_r1.texto, " ");
  }
}
function NavbarComponent_For_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function NavbarComponent_For_21_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.cerrarMenu());
    });
    \u0275\u0275text(1);
  ...
  if (rf & 2) {
    const enlace_r4 = ctx.$implicit;
    \u0275\u0275property("routerLink", enlace_r4.ruta)("routerLinkActiveOptions", \u0275\u0275pureFunction1(3, _c0, enlace_r4.exacto));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", enlace_r4.texto, " ");
  }
}
function NavbarComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function NavbarComponent_Conditional_26_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.cerrarMenu());
    });
...
var NavbarComponent = class _NavbarComponent {
  ...
  menuAbierto = signal(
    false,
    ...ngDevMode ? [{ debugName: "menuAbierto" }] : (
  ...
  constructor() {
    this.router.events.pipe(filter((e) => e instanceof NavigationEnd), takeUntilDestroyed()).subscribe(() => this.menuAbierto.set(false));
    effect(() => {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], hostBindings: function NavbarComponent_HostBindings(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275listener("keydown.escape", function NavbarComponent_keydown_escape_HostBindingHandler() {
        return ctx.onEscape();
      }, \u0275\u0275resolveDocument)("scroll", function NavbarComponent_scroll_HostBindingHandler() {
        return ctx.actualizarScroll();
      }, \u0275\u0275resolveWindow);
    }
  }, decls: 27, vars: 12, consts: [[1, "navbar"], [1, "navbar-container"], ["routerLink", "/", "aria-label", "Code.Nar - Inicio", 1, "brand"], ["src", "/images/logo.png", "alt", "", "width", "42", "height", "42", 1, "brand-mark"], [1, "brand-name"], ["aria-label", "Navegaci\xF3n principal", 1, "desktop-nav"], ["routerLinkActive", "activo", 3, "routerLink", "routerLinkActiveOptions"], ["routerLink", "/contacto", 1, "navbar-cta"], ["type", "button", "aria-controls", "menu-movil", 1, "menu-toggle", 3, "click"], [1, "menu-toggle-linea"], ["id", "menu-movil", 1, "menu-movil"], ["aria-label", "Navegaci\xF3n m\xF3vil"], ["routerLink", "/contacto", 1, "menu-movil-cta", 3, "click"], [1, "menu-overlay"], ["routerLinkActive", "activo", 3, "click", "routerLink", "routerLinkActiveOptions"], [1, "menu-overlay", 3, "click"]], template: function NavbarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(9, NavbarComponent_For_10_Template, 2, 5, "a", 6, _forTrack0);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(16, "span", 9)(17, "span", 9);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(18, "div", 10)(19, "nav", 11);
      \u0275\u0275repeaterCreate(20, NavbarComponent_For_21_Template, 4, 5, "a", 6, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "a", 12);
      \u0275\u0275listener("click", function NavbarComponent_Template_a_click_22_listener() {
        return ctx.cerrarMenu();
      });
      \u0275\u0275text(23, " Hablemos de tu proyecto ");
      \u0275\u0275elementStart(24, "span");
      \u0275\u0275text(25, "\u2197");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(26, NavbarComponent_Conditional_26_Template, 1, 0, "div", 13);
    }
    if (rf & 2) {
      \u0275\u0275classProp("navbar-scrolled", ctx.scrolled());
      \u0275\u0275advance(9);
      \u0275\u0275repeater(ctx.enlaces);
      \u0275\u0275advance(6);
      \u0275\u0275attribute("aria-expanded", ctx.menuAbierto())("aria-label", ctx.menuAbierto() ? "Cerrar men\xFA" : "Abrir men\xFA");
      \u0275\u0275advance();
      \u0275\u0275classProp("abierta", ctx.menuAbierto());
      \u0275\u0275advance();
      \u0275\u0275classProp("abierta", ctx.menuAbierto());
      \u0275\u0275advance();
      \u0275\u0275classProp("abierto", ctx.menuAbierto());
      \u0275\u0275attribute("inert", ctx.menuAbierto() ? null : "");
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.enlaces);
      \u0275\u0275advance(6);
      \u0275\u0275conditional(ctx.menuAbierto() ? 26 : -1);
    }
  }, dependencies: [RouterLink, RouterLinkActive], styles: ['\n.navbar[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  z-index: 100;\n  width: 100%;\n  padding: 18px 0;\n  background: rgba(8, 8, 8, 0.82);\n  backdrop-filter: blur(16px);\n  -webkit-backdrop-filter: blur(16px);\n  border-bottom: 1px solid rgba(255, 255, 255, 0.06);\n  transition:\n    background var(--%NS%transition),\n    border-color var(--%NS%transition),\n    padding var(--%NS%transition);\n}\n.navbar-scrolled[_ngcontent-%COMP%] {\n  padding: 12px 0;\n  background: rgba(8, 8, 8, 0.94);\n  border-bottom-color: rgba(255, 255, 255, 0.1);\n}\n.navbar-container[_ngcontent-%COMP%] {\n  width: min(calc(100% - 48px), var(--%NS%container));\n  margin: 0 auto;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.brand-mark[_ngcontent-%COMP%] {\n  width: 42px;\n  height: 42px;\n  border-radius: 11px;\n  object-fit: cover;\n  box-shadow: var(--%NS%shadow-gold);\n}\n.brand-name[_ngcontent-%COMP%] {\n  font-family: var(--%NS%font-body);\n  font-size: 21px;\n  font-weight: 700;\n  letter-spacing: -0.5px;\n}\n.brand-name[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: var(--%NS%color-gold);\n}\n.desktop-nav[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 36px;\n}\n.desktop-nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  position: relative;\n  color: var(--%NS%color-gray);\n  font-size: 13px;\n  font-weight: 500;\n  transition: color var(--%NS%transition);\n}\n.desktop-nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  bottom: -7px;\n  left: 0;\n  width: 0;\n  height: 1px;\n  background: var(--%NS%color-gold);\n  transition: width var(--%NS%transition);\n}\n.desktop-nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover, \n.desktop-nav[_ngcontent-%COMP%]   a.activo[_ngcontent-%COMP%] {\n  color: var(--%NS%color-white);\n}\n.desktop-nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover::after, \n.desktop-nav[_ngcontent-%COMP%]   a.activo[_ngcontent-%COMP%]::after {\n  width: 100%;\n}\n.desktop-nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:focus-visible, \n.navbar-cta[_ngcontent-%COMP%]:focus-visible, \n.brand[_ngcontent-%COMP%]:focus-visible {\n  outline: 2px solid var(--%NS%color-gold);\n  outline-offset: 4px;\n  border-radius: 4px;\n}\n.navbar-cta[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 12px 20px;\n  border: 1px solid rgba(212, 175, 55, 0.5);\n  border-radius: 999px;\n  background: rgba(212, 175, 55, 0.08);\n  color: var(--%NS%color-white);\n  font-size: 13px;\n  font-weight: 600;\n  transition: all var(--%NS%transition);\n}\n.navbar-cta[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: var(--%NS%color-gold);\n}\n.navbar-cta[_ngcontent-%COMP%]:hover {\n  background: var(--%NS%color-gold);\n  color: var(--%NS%color-black);\n  box-shadow: var(--%NS%shadow-gold);\n}\n.navbar-cta[_ngcontent-%COMP%]:hover   span[_ngcontent-%COMP%] {\n  color: var(--%NS%color-black);\n}\n.menu-toggle[_ngcontent-%COMP%] {\n  display: none;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 6px;\n  width: 44px;\n  height: 44px;\n  border-radius: 11px;\n  background: rgba(255, 255, 255, 0.03);\n  cursor: pointer;\n  transition: background var(--%NS%transition);\n}\n.menu-toggle[_ngcontent-%COMP%]:hover {\n  background: rgba(212, 175, 55, 0.1);\n}\n.menu-toggle[_ngcontent-%COMP%]:focus-visible {\n  outline: 2px solid var(--%NS%color-gold);\n  outline-offset: 2px;\n}\n.menu-toggle-linea[_ngcontent-%COMP%] {\n  width: 20px;\n  height: 2px;\n  border-radius: 2px;\n  background: var(--%NS%color-white);\n  transition: transform var(--%NS%transition), opacity var(--%NS%transition);\n}\n.menu-toggle-linea.abierta[_ngcontent-%COMP%]:first-child {\n  transform: translateY(4px) rotate(45deg);\n}\n.menu-toggle-linea.abierta[_ngcontent-%COMP%]:last-child {\n  transform: translateY(-4px) rotate(-45deg);\n}\n.menu-movil[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  right: 0;\n  z-index: 99;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  width: min(340px, 85vw);\n  height: 100dvh;\n  padding: 100px 32px 40px;\n  background: var(--%NS%color-black-soft);\n  border-left: 1px solid var(--%NS%color-border);\n  transform: translateX(100%);\n  visibility: hidden;\n  transition: transform 400ms cubic-bezier(0.22, 1, 0.36, 1), visibility 400ms;\n}\n.menu-movil.abierto[_ngcontent-%COMP%] {\n  transform: translateX(0);\n  visibility: visible;\n}\n.menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n}\n.menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 20px 0;\n  border-bottom: 1px solid var(--%NS%color-border);\n  color: var(--%NS%color-white-soft);\n  font-size: 19px;\n  font-weight: 600;\n  letter-spacing: -0.5px;\n  transition: color var(--%NS%transition), padding-left var(--%NS%transition);\n}\n.menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: var(--%NS%color-gray-dark);\n  font-size: 15px;\n  transition: all var(--%NS%transition);\n}\n.menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover, \n.menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a.activo[_ngcontent-%COMP%] {\n  color: var(--%NS%color-gold);\n  padding-left: 8px;\n}\n.menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover   span[_ngcontent-%COMP%], \n.menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a.activo[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: var(--%NS%color-gold);\n  transform: translate(3px, -3px);\n}\n.menu-movil-cta[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 10px;\n  min-height: 54px;\n  margin-top: 32px;\n  border-radius: 999px;\n  background: var(--%NS%color-gold);\n  color: var(--%NS%color-black);\n  font-size: 14px;\n  font-weight: 600;\n  box-shadow: var(--%NS%shadow-gold);\n}\n.menu-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  inset: 0;\n  z-index: 98;\n  background: rgba(0, 0, 0, 0.6);\n  backdrop-filter: blur(3px);\n  -webkit-backdrop-filter: blur(3px);\n  animation: _ngcontent-%COMP%_aparecer 300ms ease;\n}\n@keyframes _ngcontent-%COMP%_aparecer {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n}\n@media (max-width: 900px) {\n  .desktop-nav[_ngcontent-%COMP%], \n   .navbar-cta[_ngcontent-%COMP%] {\n    display: none;\n  }\n  .menu-toggle[_ngcontent-%COMP%] {\n    display: flex;\n  }\n}\n@media (max-width: 600px) {\n  .navbar-container[_ngcontent-%COMP%] {\n    width: min(calc(100% - 32px), var(--%NS%container));\n  }\n  .brand-name[_ngcontent-%COMP%] {\n    font-size: 19px;\n  }\n  .brand-mark[_ngcontent-%COMP%] {\n    width: 38px;\n    height: 38px;\n  }\n}\n@media (prefers-reduced-motion: reduce) {\n  .menu-movil[_ngcontent-%COMP%] {\n    transition-duration: 1ms;\n  }\n  .menu-overlay[_ngcontent-%COMP%] {\n    animation: none;\n  }\n}\n@supports (padding: max(0px)) {\n  .navbar-container[_ngcontent-%COMP%] {\n    padding-left: max(0px, env(safe-area-inset-left));\n    padding-right: max(0px, env(safe-area-inset-right));\n  }\n  .menu-movil[_ngcontent-%COMP%] {\n    padding-right: max(32px, env(safe-area-inset-right));\n    padding-bottom: max(40px, env(safe-area-inset-bottom));\n  }\n}\n@media (hover: none) {\n  .menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n    padding-left: 0;\n  }\n  .menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover   span[_ngcontent-%COMP%] {\n    transform: none;\n  }\n}\n@media (max-width: 400px) {\n  .menu-movil[_ngcontent-%COMP%] {\n    width: min(300px, 88vw);\n    padding-left: 26px;\n    padding-right: 26px;\n  }\n  .menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n    padding: 17px 0;\n    font-size: 17px;\n  }\n}\n@media (max-height: 560px) {\n  .menu-movil[_ngcontent-%COMP%] {\n    justify-content: flex-start;\n    padding-top: 88px;\n    overflow-y: auto;\n  }\n  .menu-movil[_ngcontent-%COMP%]   nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n    padding: 14px 0;\n    font-size: 16px;\n  }\n}\n/*# sourceMappingURL=navbar.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NavbarComponent, [{
    type: Component,
    args: [{ selector: "app-navbar", standalone: true, imports: [RouterLink, RouterLinkActive], template: `<header class="navbar" [class.navbar-scrolled]="scrolled()">\r
    <div class="navbar-container">\r
\r
        <a routerLink="/" class="brand" aria-label="Code.Nar - Inicio">\r
            <img src="/images/logo.png" alt="" class="brand-mark" width="42" height="42" />\r
            <span class="brand-name">Code.<span>Nar</span></span>\r
        </a>\r
\r
        <nav class="desktop-nav" aria-label="Navegaci\xF3n principal">\r
            @for (enlace of enlaces; track enlace.ruta) {\r
            <a [routerLink]="enlace.ruta" routerLinkActive="activo"\r
                [routerLinkActiveOptions]="{ exact: enlace.exacto }">\r
                {{ enlace.texto }}\r
            </a>\r
            }\r
        </nav>\r
\r
        <a routerLink="/contacto" class="navbar-cta">\r
            Hablemos\r
            <span>\u2197</span>\r
        </a>\r
\r
        <button type="button" class="menu-toggle" (click)="alternarMenu()" [attr.aria-expanded]="menuAbierto()"\r
            aria-controls="menu-movil" [attr.aria-label]="menuAbierto() ? 'Cerrar men\xFA' : 'Abrir men\xFA'">\r
            <span class="menu-toggle-linea" [class.abierta]="menuAbierto()"></span>\r
            <span class="menu-toggle-linea" [class.abierta]="menuAbierto()"></span>\r
        </button>\r
\r
    </div>\r
...
<!-- ================================\r
     ...
     ================================ -->\r
\r
<div class="menu-movil" id="menu-movil" [class.abierto]="menuAbierto()" [attr.inert]="menuAbierto() ? null : ''">\r
\r
    <nav aria-label="Navegaci\xF3n m\xF3vil">\r
        @for (enlace of enlaces; track enlace.ruta) {\r
        <a [routerLink]="enlace.ruta" routerLinkActive="activo" [routerLinkActiveOptions]="{ exact: enlace.exacto }"\r
            (click)="cerrarMenu()">\r
            {{ enlace.texto }}\r
            <span>\u2197</span>\r
        </a>\r
...
\r
    <a routerLink="/contacto" class="menu-movil-cta" (click)="cerrarMenu()">\r
        Hablemos de tu proyecto\r
        <span>\u2197</span>\r
    </a>\r
\r
</div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavbarComponent, { className: "NavbarComponent", filePath: "app/components/navbar/navbar.ts", lineNumber: 22 });
})();
...
var FooterComponent = class _FooterComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], decls: 49, vars: 0, consts: [[1, "footer"], [1, "footer-container"], [1, "footer-main"], [1, "footer-brand"], ["routerLink", "/", "aria-label", "Code.Nar - Inicio", 1, "brand"], ["aria-hidden", "true", 1, "brand-mark"], [1, "brand-name"], [1, "footer-column"], ["routerLink", "/"], ["routerLink", "/servicios"], ["routerLink", "/proyectos"], ["routerLink", "/contacto"], ["routerLink", "/servicios", "fragment", "desarrollo-web"], ["routerLink", "/servicios", "fragment", "tiendas-online"], ["routerLink", "/servicios", "fragment", "sistemas-web"], ["routerLink", "/servicios", "fragment", "soluciones-digitales"], ["routerLink", "/nosotros"], [1, "footer-bottom"]], template: function FooterComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "footer", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3)(4, "a", 4)(5, "span", 5);
      \u0275\u0275text(6, "C");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(11, "p");
      \u0275\u0275text(12, " Creamos soluciones digitales modernas para empresas, emprendimientos y profesionales. ");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(28, " Desarrollo Web ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "a", 13);
      \u0275\u0275text(30, " Tiendas Online ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "a", 14);
      \u0275\u0275text(32, " Sistemas Web ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "a", 15);
      \u0275\u0275text(34, " Soluciones Digitales ");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(43, "Pasto, Nari\xF1o \u2014 Colombia");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(44, "div", 17)(45, "span");
      \u0275\u0275text(46, " \xA9 2026 Code.Nar Todos los derechos reservados. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "span");
      \u0275\u0275text(48, " Desarrollo digital en Colombia ");
      \u0275\u0275elementEnd()()()();
    }
  }, dependencies: [RouterLink], styles: ["\n.footer[_ngcontent-%COMP%] {\n  padding: 90px 0 30px;\n  background: #060606;\n  border-top: 1px solid var(--%NS%color-border);\n}\n.footer-container[_ngcontent-%COMP%] {\n  width: min(calc(100% - 48px), var(--%NS%container));\n  margin: 0 auto;\n}\n.footer-main[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 2fr 1fr 1fr 1fr;\n  gap: 60px;\n  padding-bottom: 70px;\n}\n.footer-brand[_ngcontent-%COMP%] {\n  max-width: 320px;\n}\n.footer-brand[_ngcontent-%COMP%]   .brand[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: 12px;\n}\n.footer-brand[_ngcontent-%COMP%]   .brand-mark[_ngcontent-%COMP%] {\n  display: grid;\n  place-items: center;\n  width: 42px;\n  height: 42px;\n  border-radius: 11px;\n  background: var(--%NS%color-gold);\n  color: var(--%NS%color-black);\n  font-size: 20px;\n  font-weight: 700;\n  box-shadow: var(--%NS%shadow-gold);\n}\n.footer-brand[_ngcontent-%COMP%]   .brand-name[_ngcontent-%COMP%] {\n  font-size: 21px;\n  font-weight: 700;\n  letter-spacing: -0.5px;\n}\n.footer-brand[_ngcontent-%COMP%]   .brand-name[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: var(--%NS%color-gold);\n}\n.footer-column[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:focus-visible, \n.footer-brand[_ngcontent-%COMP%]   .brand[_ngcontent-%COMP%]:focus-visible {\n  outline: 2px solid var(--%NS%color-gold);\n  outline-offset: 4px;\n  border-radius: 4px;\n}\n.footer-brand[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 24px 0 0;\n  color: var(--%NS%color-gray);\n  font-size: 13px;\n  line-height: 1.8;\n}\n.footer-column[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 13px;\n}\n.footer-column[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  margin: 0 0 12px;\n  color: var(--%NS%color-white);\n  font-size: 11px;\n  font-weight: 600;\n  letter-spacing: 1.5px;\n  text-transform: uppercase;\n}\n.footer-column[_ngcontent-%COMP%]   a[_ngcontent-%COMP%], \n.footer-column[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: var(--%NS%color-gray);\n  font-size: 12px;\n  transition: color var(--%NS%transition);\n}\n.footer-column[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n  color: var(--%NS%color-gold);\n}\n.footer-bottom[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding-top: 25px;\n  border-top: 1px solid var(--%NS%color-border);\n  color: var(--%NS%color-gray-dark);\n  font-size: 10px;\n}\n@media (max-width: 800px) {\n  .footer[_ngcontent-%COMP%] {\n    padding: 70px 0 25px;\n  }\n  .footer-main[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr 1fr;\n    gap: 45px 30px;\n    padding-bottom: 50px;\n  }\n}\n@media (max-width: 500px) {\n  .footer-container[_ngcontent-%COMP%] {\n    width: min(calc(100% - 32px), var(--%NS%container));\n  }\n  .footer-main[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr 1fr;\n  }\n  .footer-brand[_ngcontent-%COMP%] {\n    grid-column: 1 / -1;\n  }\n  .footer-bottom[_ngcontent-%COMP%] {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 10px;\n  }\n}\n@media (max-width: 700px) {\n  .footer-column[_ngcontent-%COMP%] {\n    gap: 4px;\n  }\n  .footer-column[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n    padding: 9px 0;\n    font-size: 13px;\n  }\n  .footer-column[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n    padding: 9px 0;\n    font-size: 13px;\n  }\n  .footer-brand[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n    font-size: 13.5px;\n  }\n  .footer-bottom[_ngcontent-%COMP%] {\n    font-size: 11.5px;\n    line-height: 1.7;\n  }\n}\n@supports (padding: max(0px)) {\n  .footer[_ngcontent-%COMP%] {\n    padding-bottom: max(30px, env(safe-area-inset-bottom));\n  }\n}\n/*# sourceMappingURL=footer.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FooterComponent, [{
    type: Component,
    args: [{ selector: "app-footer", standalone: true, imports: [RouterLink], template: '<footer class="footer">\r\n    <div class="footer-container">\r\n\r\n        <div class="footer-main">\r\n\r\n            <div class="footer-brand">\r\n                <a routerLink="/" class="brand" aria-label="Code.Nar - Inicio">\r\n                    <span class="brand-mark" aria-hidden="true">C</span>\r\n                    <span class="brand-name">\r\n                        Code.<span>Nar</span>\r\n                    </span>\r\n                </a>\r\n\r\n                <p>\r\n                    Creamos soluciones digitales modernas\r\n                    para empresas, emprendimientos y\r\n                    profesionales.\r\n                </p>\r\n            </div>\r\n\r\n\r\n            <div class="footer-column">\r\n                <h3>Explorar</h3>\r\n\r\n                <a routerLink="/">Inicio</a>\r\n                <a routerLink="/servicios">Servicios</a>\r\n                <a routerLink="/proyectos">Proyectos</a>\r\n                <a routerLink="/contacto">Contacto</a>\r\n            </div>\r\n\r\n\r\n            <div class="footer-column">\r\n                <h3>Servicios</h3>\r\n\r\n                <a routerLink="/servicios" fragment="desarrollo-web">\r\n                    Desarrollo Web\r\n                </a>\r\n\r\n                <a routerLink="/servicios" fragment="tiendas-online">\r\n                    Tiendas Online\r\n                </a>\r\n\r\n                <a routerLink="/servicios" fragment="sistemas-web">\r\n                    Sistemas Web\r\n                </a>\r\n\r\n                <a routerLink="/servicios" fragment="soluciones-digitales">\r\n                    Soluciones Digitales\r\n                </a>\r\n            </div>\r\n\r\n\r\n            <div class="footer-column">\r\n                <h3>Contacto</h3>\r\n\r\n                <a routerLink="/contacto">\r\n                    Hablemos\r\n                </a>\r\n\r\n                <a routerLink="/nosotros">\r\n                    Nosotros\r\n                </a>\r\n\r\n                <span>Pasto, Nari\xF1o \u2014 Colombia</span>\r\n            </div>\r\n\r\n        </div>\r\n\r\n\r\n        <div class="footer-bottom">\r\n\r\n            <span>\r\n                \xA9 2026 Code.Nar Todos los derechos reservados.\r\n            </span>\r\n\r\n            <span>\r\n                Desarrollo digital en Colombia\r\n            </span>\r\n\r\n        </div>\r\n\r\n    </div>\r\n</footer>\r\n', styles: ["/* src/app/components/footer/footer.css */\n.footer {\n  padding: 90px 0 30px;\n  background: #060606;\n  border-top: 1px solid var(--color-border);\n}\n.footer-container {\n  width: min(calc(100% - 48px), var(--container));\n  margin: 0 auto;\n}\n.footer-main {\n  display: grid;\n  grid-template-columns: 2fr 1fr 1fr 1fr;\n  gap: 60px;\n  padding-bottom: 70px;\n}\n.footer-brand {\n  max-width: 320px;\n}\n.footer-brand .brand {\n  display: inline-flex;\n  align-items: center;\n  gap: 12px;\n}\n.footer-brand .brand-mark {\n  display: grid;\n  place-items: center;\n  width: 42px;\n  height: 42px;\n  border-radius: 11px;\n  background: var(--color-gold);\n  color: var(--color-black);\n  font-size: 20px;\n  font-weight: 700;\n  box-shadow: var(--shadow-gold);\n}\n.footer-brand .brand-name {\n  font-size: 21px;\n  font-weight: 700;\n  letter-spacing: -0.5px;\n}\n.footer-brand .brand-name span {\n  color: var(--color-gold);\n}\n.footer-column a:focus-visible,\n.footer-brand .brand:focus-visible {\n  outline: 2px solid var(--color-gold);\n  outline-offset: 4px;\n  border-radius: 4px;\n}\n.footer-brand p {\n  margin: 24px 0 0;\n  color: var(--color-gray);\n  font-size: 13px;\n  line-height: 1.8;\n}\n.footer-column {\n  display: flex;\n  flex-direction: column;\n  gap: 13px;\n}\n.footer-column h3 {\n  margin: 0 0 12px;\n  color: var(--color-white);\n  font-size: 11px;\n  font-weight: 600;\n  letter-spacing: 1.5px;\n  text-transform: uppercase;\n}\n.footer-column a,\n.footer-column span {\n  color: var(--color-gray);\n  font-size: 12px;\n  transition: color var(--transition);\n}\n.footer-column a:hover {\n  color: var(--color-gold);\n}\n.footer-bottom {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding-top: 25px;\n  border-top: 1px solid var(--color-border);\n  color: var(--color-gray-dark);\n  font-size: 10px;\n}\n@media (max-width: 800px) {\n  .footer {\n    padding: 70px 0 25px;\n  }\n  .footer-main {\n    grid-template-columns: 1fr 1fr;\n    gap: 45px 30px;\n    padding-bottom: 50px;\n  }\n}\n@media (max-width: 500px) {\n  .footer-container {\n    width: min(calc(100% - 32px), var(--container));\n  }\n  .footer-main {\n    grid-template-columns: 1fr 1fr;\n  }\n  .footer-brand {\n    grid-column: 1 / -1;\n  }\n  .footer-bottom {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 10px;\n  }\n}\n@media (max-width: 700px) {\n  .footer-column {\n    gap: 4px;\n  }\n  .footer-column a {\n    padding: 9px 0;\n    font-size: 13px;\n  }\n  .footer-column span {\n    padding: 9px 0;\n    font-size: 13px;\n  }\n  .footer-brand p {\n    font-size: 13.5px;\n  }\n  .footer-bottom {\n    font-size: 11.5px;\n    line-height: 1.7;\n  }\n}\n@supports (padding: max(0px)) {\n  .footer {\n    padding-bottom: max(30px, env(safe-area-inset-bottom));\n  }\n}\n/*# sourceMappingURL=footer.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "app/components/footer/footer.ts", lineNumber: 11 });
})();

// src/app/components/whatsapp-button/whatsapp-button.ts
var WhatsappButtonComponent = class _WhatsappButtonComponent {
  static \u0275fac = function WhatsappButtonComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _WhatsappButtonComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _WhatsappButtonComponent, selectors: [["app-whatsapp-button"]], decls: 12, vars: 0, consts: [[1, "social-floating"], ["href", "https://www.instagram.com/CodeNar", "target", "_blank", "rel", "noopener noreferrer", "aria-label", "Code.Nar en Instagram", "title", "Instagram", 1, "social-icon-button", "social-icon-button--instagram"], ["viewBox", "0 0 24 24", "aria-hidden", "true", "focusable", "false"], ["d", "M12 2.2c3.2 0 3.6 0 4.9.1 1.2.1 1.9.2 2.3.4.6.2 1 .5 1.4.9.4.4.7.8.9 1.4.2.4.3 1.1.4 2.3.1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c-.1 1.2-.2 1.9-.4 2.3-.2.6-.5 1-.9 1.4-.4.4-.8.7-1.4.9-.4.2-1.1.3-2.3.4-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.2-.1-1.9-.2-2.3-.4-.6-.2-1-.5-1.4-.9-.4-.4-.7-.8-.9-1.4-.2-.4-.3-1.1-.4-2.3C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.9c.1-1.2.2-1.9.4-2.3.2-.6.5-1 .9-1.4.4-.4.8-.7 1.4-.9.4-.2 1.1-.3 2.3-.4C8.4 2.2 8.8 2.2 12 2.2Zm0 1.8c-3.1 0-3.5 0-4.7.1-1 .05-1.6.2-1.9.3-.5.2-.8.4-1.2.8-.4.4-.6.7-.8 1.2-.1.3-.3.9-.3 1.9-.1 1.2-.1 1.6-.1 4.7s0 3.5.1 4.7c.1 1 .2 1.6.3 1.9.2.5.4.8.8 1.2.4.4.7.6 1.2.8.3.1.9.3 1.9.3 1.2.1 1.6.1 4.7.1s3.5 0 4.7-.1c1-.1 1.6-.2 1.9-.3.5-.2.8-.4 1.2-.8.4-.4.6-.7.8-1.2.1-.3.3-.9.3-1.9.1-1.2.1-1.6.1-4.7s0-3.5-.1-4.7c-.1-1-.2-1.6-.3-1.9-.2-.5-.4-.8-.8-1.2-.4-.4-.7-.6-1.2-.8-.3-.1-.9-.3-1.9-.3-1.2-.1-1.6-.1-4.7-.1Zm0 3.9a4.1 4.1 0 1 1 0 8.2 4.1 4.1 0 0 1 0-8.2Zm0 1.8a2.3 2.3 0 1 0 0 4.6 2.3 2.3 0 0 0 0-4.6Zm5.2-2a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"], ["href", "https://www.tiktok.com/@CodeNar", "target", "_blank", "rel", "noopener noreferrer", "aria-label", "Code.Nar en TikTok", "title", "TikTok", 1, "social-icon-button", "social-icon-button--tiktok"], ["d", "M16.5 2h-3.1v13.9a2.6 2.6 0 1 1-2.2-2.6v-3.2a5.8 5.8 0 1 0 5.3 5.8V8.9a7.7 7.7 0 0 0 4.4 1.4V7.2a4.6 4.6 0 0 1-4.4-4.5V2Z"], ["href", "https://wa.me/573200000000?text=Hola%20Code.Nar%2C%20quiero%20hablar%20sobre%20mi%20proyecto.", "target", "_blank", "rel", "noopener noreferrer", "aria-label", "Escribir a Code.Nar por WhatsApp", "title", "Escr\xEDbenos por WhatsApp", 1, "whatsapp-button"], ["viewBox", "0 0 32 32", "aria-hidden", "true", "focusable", "false"], ["d", "M16 3.2a12.7 12.7 0 0 0-10.9 19.2L3.5 28.8l6.6-1.7A12.8 12.8 0 1 0 16 3.2Zm0 22.9c-2 0-3.9-.5-5.6-1.5l-.4-.2-3.9 1 1-3.8-.3-.4a10.2 10.2 0 1 1 9.2 4.9Zm5.6-7.6c-.3-.2-1.9-.9-2.2-1-.3-.1-.5-.2-.7.2s-.8 1-.9 1.2c-.2.2-.3.2-.6.1-1.9-.9-3.1-1.7-4.3-3.9-.2-.3 0-.5.1-.6l.5-.6c.2-.2.2-.4.3-.6.1-.2 0-.5 0-.6s-.7-1.7-.9-2.3c-.3-.7-.6-.6-.8-.6h-.7c-.2 0-.6.1-.9.5-.3.4-1.2 1.2-1.2 3s1.2 3.5 1.3 3.8c.2.2 2.3 3.5 5.5 4.9.8.3 1.4.5 1.9.7.8.2 1.5.2 2.1.1.6-.1 1.9-.8 2.1-1.6.3-.8.3-1.5.2-1.6-.1-.1-.3-.2-.6-.4Z"]], template: function WhatsappButtonComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275namespaceSVG();
      \u0275\u0275domElementStart(5, "svg", 2);
      \u0275\u0275domElement(6, "path", 5);
      \u0275\u0275domElementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275domElementStart(7, "a", 6);
      \u0275\u0275namespaceSVG();
      \u0275\u0275domElementStart(8, "svg", 7);
      \u0275\u0275domElement(9, "path", 8);
      \u0275\u0275domElementEnd();
      \u0275\u0275namespaceHTML();
      \u0275\u0275domElementStart(10, "span");
      \u0275\u0275text(11, "Hablemos por WhatsApp");
      \u0275\u0275domElementEnd()()();
    }
  }, styles: ["\n.social-floating[_ngcontent-%COMP%] {\n  position: fixed;\n  right: 24px;\n  bottom: 24px;\n  z-index: 50;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  gap: 12px;\n}\n.social-icon-button[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 46px;\n  height: 46px;\n  border: 1px solid rgba(255, 255, 255, 0.18);\n  border-radius: 50%;\n  color: #fff;\n  box-shadow: 0 10px 28px rgba(0, 0, 0, 0.4);\n  transition:\n    transform var(--%NS%transition),\n    box-shadow var(--%NS%transition),\n    filter var(--%NS%transition);\n}\n.social-icon-button[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 20px;\n  height: 20px;\n  fill: currentColor;\n}\n.social-icon-button[_ngcontent-%COMP%]:hover {\n  filter: brightness(1.12) saturate(1.15);\n  transform: translateY(-3px);\n  box-shadow: 0 14px 34px rgba(0, 0, 0, 0.45);\n}\n.social-icon-button--instagram[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #feda75 0%,\n      #fa7e1e 22%,\n      #d62976 55%,\n      #962fbf 78%,\n      #4f5bd5 100%);\n}\n.social-icon-button--tiktok[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #25f4ee 0%,\n      #0a0a0a 48%,\n      #fe2c55 100%);\n}\n.whatsapp-button[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: 10px;\n  min-height: 54px;\n  padding: 0 18px 0 14px;\n  border: 1px solid rgba(255, 255, 255, .2);\n  border-radius: 999px;\n  background: #25d366;\n  color: #07140b;\n  box-shadow: 0 14px 34px rgba(0, 0, 0, .32);\n  font-size: 12px;\n  font-weight: 700;\n  transition:\n    transform var(--%NS%transition),\n    box-shadow var(--%NS%transition),\n    background var(--%NS%transition);\n}\n.whatsapp-button[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  width: 27px;\n  height: 27px;\n  fill: currentColor;\n}\n.whatsapp-button[_ngcontent-%COMP%]:hover {\n  background: #42df7b;\n  box-shadow: 0 18px 42px rgba(37, 211, 102, .26);\n  transform: translateY(-4px);\n}\n@media (max-width: 600px) {\n  .social-floating[_ngcontent-%COMP%] {\n    right: 16px;\n    bottom: 16px;\n    gap: 10px;\n  }\n  .social-icon-button[_ngcontent-%COMP%] {\n    width: 40px;\n    height: 40px;\n  }\n  .social-icon-button[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n    width: 17px;\n    height: 17px;\n  }\n  .whatsapp-button[_ngcontent-%COMP%] {\n    width: 48px;\n    height: 48px;\n    min-height: 48px;\n    padding: 0;\n    justify-content: center;\n  }\n  .whatsapp-button[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n    width: 23px;\n    height: 23px;\n  }\n  .whatsapp-button[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n    position: absolute;\n    width: 1px;\n    height: 1px;\n    overflow: hidden;\n    clip: rect(0 0 0 0);\n    white-space: nowrap;\n  }\n}\n@media (hover: none) {\n  .social-icon-button[_ngcontent-%COMP%]:hover, \n   .whatsapp-button[_ngcontent-%COMP%]:hover {\n    transform: none;\n  }\n}\n.social-icon-button[_ngcontent-%COMP%]:focus-visible, \n.whatsapp-button[_ngcontent-%COMP%]:focus-visible {\n  outline: 2px solid var(--%NS%color-gold-light);\n  outline-offset: 3px;\n}\n/*# sourceMappingURL=whatsapp-button.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(WhatsappButtonComponent, [{
    type: Component,
    args: [{ selector: "app-whatsapp-button", standalone: true, template: '<div class="social-floating">\n\n  <a\n    class="social-icon-button social-icon-button--instagram"\n    href="https://www.instagram.com/CodeNar"\n    target="_blank"\n    rel="noopener noreferrer"\n    aria-label="Code.Nar en Instagram"\n    title="Instagram"\n  >\n    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">\n      <path d="M12 2.2c3.2 0 3.6 0 4.9.1 1.2.1 1.9.2 2.3.4.6.2 1 .5 1.4.9.4.4.7.8.9 1.4.2.4.3 1.1.4 2.3.1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c-.1 1.2-.2 1.9-.4 2.3-.2.6-.5 1-.9 1.4-.4.4-.8.7-1.4.9-.4.2-1.1.3-2.3.4-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.2-.1-1.9-.2-2.3-.4-.6-.2-1-.5-1.4-.9-.4-.4-.7-.8-.9-1.4-.2-.4-.3-1.1-.4-2.3C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.9c.1-1.2.2-1.9.4-2.3.2-.6.5-1 .9-1.4.4-.4.8-.7 1.4-.9.4-.2 1.1-.3 2.3-.4C8.4 2.2 8.8 2.2 12 2.2Zm0 1.8c-3.1 0-3.5 0-4.7.1-1 .05-1.6.2-1.9.3-.5.2-.8.4-1.2.8-.4.4-.6.7-.8 1.2-.1.3-.3.9-.3 1.9-.1 1.2-.1 1.6-.1 4.7s0 3.5.1 4.7c.1 1 .2 1.6.3 1.9.2.5.4.8.8 1.2.4.4.7.6 1.2.8.3.1.9.3 1.9.3 1.2.1 1.6.1 4.7.1s3.5 0 4.7-.1c1-.1 1.6-.2 1.9-.3.5-.2.8-.4 1.2-.8.4-.4.6-.7.8-1.2.1-.3.3-.9.3-1.9.1-1.2.1-1.6.1-4.7s0-3.5-.1-4.7c-.1-1-.2-1.6-.3-1.9-.2-.5-.4-.8-.8-1.2-.4-.4-.7-.6-1.2-.8-.3-.1-.9-.3-1.9-.3-1.2-.1-1.6-.1-4.7-.1Zm0 3.9a4.1 4.1 0 1 1 0 8.2 4.1 4.1 0 0 1 0-8.2Zm0 1.8a2.3 2.3 0 1 0 0 4.6 2.3 2.3 0 0 0 0-4.6Zm5.2-2a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"/>\n    </svg>\n  </a>\n\n  <a\n    class="social-icon-button social-icon-button--tiktok"\n    href="https://www.tiktok.com/@CodeNar"\n    target="_blank"\n    rel="noopener noreferrer"\n    aria-label="Code.Nar en TikTok"\n    title="TikTok"\n  >\n    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">\n      <path d="M16.5 2h-3.1v13.9a2.6 2.6 0 1 1-2.2-2.6v-3.2a5.8 5.8 0 1 0 5.3 5.8V8.9a7.7 7.7 0 0 0 4.4 1.4V7.2a4.6 4.6 0 0 1-4.4-4.5V2Z"/>\n    </svg>\n  </a>\n\n  <a\n    class="whatsapp-button"\n    href="https://wa.me/573200000000?text=Hola%20Code.Nar%2C%20quiero%20hablar%20sobre%20mi%20proyecto."\n    target="_blank"\n    rel="noopener noreferrer"\n    aria-label="Escribir a Code.Nar por WhatsApp"\n    title="Escr\xEDbenos por WhatsApp"\n  >\n    <svg viewBox="0 0 32 32" aria-hidden="true" focusable="false">\n      <path d="M16 3.2a12.7 12.7 0 0 0-10.9 19.2L3.5 28.8l6.6-1.7A12.8 12.8 0 1 0 16 3.2Zm0 22.9c-2 0-3.9-.5-5.6-1.5l-.4-.2-3.9 1 1-3.8-.3-.4a10.2 10.2 0 1 1 9.2 4.9Zm5.6-7.6c-.3-.2-1.9-.9-2.2-1-.3-.1-.5-.2-.7.2s-.8 1-.9 1.2c-.2.2-.3.2-.6.1-1.9-.9-3.1-1.7-4.3-3.9-.2-.3 0-.5.1-.6l.5-.6c.2-.2.2-.4.3-.6.1-.2 0-.5 0-.6s-.7-1.7-.9-2.3c-.3-.7-.6-.6-.8-.6h-.7c-.2 0-.6.1-.9.5-.3.4-1.2 1.2-1.2 3s1.2 3.5 1.3 3.8c.2.2 2.3 3.5 5.5 4.9.8.3 1.4.5 1.9.7.8.2 1.5.2 2.1.1.6-.1 1.9-.8 2.1-1.6.3-.8.3-1.5.2-1.6-.1-.1-.3-.2-.6-.4Z"/>\n    </svg>\n    <span>Hablemos por WhatsApp</span>\n  </a>\n\n</div>\n', styles: ["/* src/app/components/whatsapp-button/whatsapp-button.css */\n.social-floating {\n  position: fixed;\n  right: 24px;\n  bottom: 24px;\n  z-index: 50;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  gap: 12px;\n}\n.social-icon-button {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 46px;\n  height: 46px;\n  border: 1px solid rgba(255, 255, 255, 0.18);\n  border-radius: 50%;\n  color: #fff;\n  box-shadow: 0 10px 28px rgba(0, 0, 0, 0.4);\n  transition:\n    transform var(--transition),\n    box-shadow var(--transition),\n    filter var(--transition);\n}\n.social-icon-button svg {\n  width: 20px;\n  height: 20px;\n  fill: currentColor;\n}\n.social-icon-button:hover {\n  filter: brightness(1.12) saturate(1.15);\n  transform: translateY(-3px);\n  box-shadow: 0 14px 34px rgba(0, 0, 0, 0.45);\n}\n.social-icon-button--instagram {\n  background:\n    linear-gradient(\n      135deg,\n      #feda75 0%,\n      #fa7e1e 22%,\n      #d62976 55%,\n      #962fbf 78%,\n      #4f5bd5 100%);\n}\n.social-icon-button--tiktok {\n  background:\n    linear-gradient(\n      135deg,\n      #25f4ee 0%,\n      #0a0a0a 48%,\n      #fe2c55 100%);\n}\n.whatsapp-button {\n  display: inline-flex;\n  align-items: center;\n  gap: 10px;\n  min-height: 54px;\n  padding: 0 18px 0 14px;\n  border: 1px solid rgba(255, 255, 255, .2);\n  border-radius: 999px;\n  background: #25d366;\n  color: #07140b;\n  box-shadow: 0 14px 34px rgba(0, 0, 0, .32);\n  font-size: 12px;\n  font-weight: 700;\n  transition:\n    transform var(--transition),\n    box-shadow var(--transition),\n    background var(--transition);\n}\n.whatsapp-button svg {\n  width: 27px;\n  height: 27px;\n  fill: currentColor;\n}\n.whatsapp-button:hover {\n  background: #42df7b;\n  box-shadow: 0 18px 42px rgba(37, 211, 102, .26);\n  transform: translateY(-4px);\n}\n@media (max-width: 600px) {\n  .social-floating {\n    right: 16px;\n    bottom: 16px;\n    gap: 10px;\n  }\n  .social-icon-button {\n    width: 40px;\n    height: 40px;\n  }\n  .social-icon-button svg {\n    width: 17px;\n    height: 17px;\n  }\n  .whatsapp-button {\n    width: 48px;\n    height: 48px;\n    min-height: 48px;\n    padding: 0;\n    justify-content: center;\n  }\n  .whatsapp-button svg {\n    width: 23px;\n    height: 23px;\n  }\n  .whatsapp-button span {\n    position: absolute;\n    width: 1px;\n    height: 1px;\n    overflow: hidden;\n    clip: rect(0 0 0 0);\n    white-space: nowrap;\n  }\n}\n@media (hover: none) {\n  .social-icon-button:hover,\n  .whatsapp-button:hover {\n    transform: none;\n  }\n}\n.social-icon-button:focus-visible,\n.whatsapp-button:focus-visible {\n  outline: 2px solid var(--color-gold-light);\n  outline-offset: 3px;\n}\n/*# sourceMappingURL=whatsapp-button.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WhatsappButtonComponent, { className: "WhatsappButtonComponent", filePath: "app/components/whatsapp-button/whatsapp-button.ts", lineNumber: 9 });
})();
...
var App = class _App {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 4, vars: 0, template: function App_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "app-navbar")(1, "router-outlet")(2, "app-footer")(3, "app-whatsapp-button");
    }
  }, dependencies: [
    RouterOutlet,
    NavbarComponent,
...
var routes = [
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-OP3TOTZW.mjs").then((m) => m.Home)
  }, true ? { \u0275entryName: "src/app/pages/home/home.ts" } : {}),
  __spreadValues({
    path: "servicios",
    title: "Servicios de desarrollo web y soluciones digitales | Code.Nar",
    loadComponent: () => import("./chunk-O7R2JPCK.mjs").then((m) => m.Servicios)
  }, true ? { \u0275entryName: "src/app/pages/servicios/servicios.ts" } : {}),
  __spreadValues({
    path: "proyectos",
    title: "Proyectos de desarrollo web y sistemas | Code.Nar",
    loadComponent: () => import("./chunk-OF54MUR3.mjs").then((m) => m.Proyectos)
  }, true ? { \u0275entryName: "src/app/pages/proyectos/proyectos.ts" } : {}),
  __spreadValues({
    path: "nosotros",
    title: "Nuestro equipo de desarrollo web | Code.Nar",
    loadComponent: () => import("./chunk-ZA4BOC3Y.mjs").then((m) => m.Nosotros)
  }, true ? { \u0275entryName: "src/app/pages/nosotros/nosotros.ts" } : {}),
  __spreadValues({
    path: "contacto",
    title: "Contacto para tu proyecto digital | Code.Nar",
    loadComponent: () => import("./chunk-HQBF4V7U.mjs").then((m) => m.Contacto)
  }, true ? { \u0275entryName: "src/app/pages/contacto/contacto.ts" } : {}),
  {
    path: "**",
    redirectTo: ""
  }
